                    ...
                    <div class="collapse navbar-collapse tm-nav" id="navbar-nav">
                        <ul class="navbar-nav text-uppercase">
                            ...
                            <li class="nav-item active">
                                <a class="nav-link tm-nav-link" href="serv">ԾԱՌԱՅՈՒՏՅՈՒՆՆԵՐ <span class="sr-only">(current)</span></a>
                            </li>
                            <li class="nav-item">
                ...
                <section class="tm-content">
                    <div class="media my-3 mb-5 tm-service-media tm-service-media-img-l">
                        ...
                        <div class="media-body tm-service-text">
                            ...
                            <p>Our template is simple and effective. This is an alternating simple content with a
                    ...
                    <div class="media my-3 mb-5 tm-service-media">
                        <div class="media-body tm-service-text">
                            ...
                            <p>Feel free to contact TemplateMo for any kind of question. If you wish to support us, you
                                can make a PayPal donation. Thank you.</p>
                        </div>
                    ...
                    <div class="media my-3 tm-service-media tm-service-media-img-l">
                        ...
                        <div class="media-body tm-service-text">
                            ...
                            <p>You are NOT allowed to redistribute this template ZIP file for a download purpose on any
