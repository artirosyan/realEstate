                    ...
                    <div class="collapse navbar-collapse tm-nav" id="navbar-nav">
                        <ul class="navbar-nav text-uppercase">
                            <li class="nav-item active">
                                <a class="nav-link tm-nav-link" href="index.jsp">ՏՈՒՆ <span class="sr-only">(current)</span></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link tm-nav-link" href="about">ՄԵՐ ՄԱՍԻՆ</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link tm-nav-link" href="serv">ԾԱՌԱՅՈՒՏՅՈՒՆՆԵՐ</a>
                            </li>
                            <li class="nav-item">
            ...
            <main class="tm-col-right">
                <section class="tm-content">
                    ...
                    <p class="mb-5">Diagoona is provided by TemplateMo website. You are allowed to use this template for
                        your websites. You are NOT allowed to redistribute this template ZIP file for a download purpose
                        on any template collection website.</p>
                    <hr class="mb-5">
                    <p class="mb-5">Diagoona is Bootstrap v4.4.1 layout. This BG is 50% transparent. You can set the
                        background images auto play settings (true or false in line number 33) in templatemo-script.js
                        file in js folder.</p>
                    <a href="about" class="btn btn-primary">Continue...</a>
                </section>
            </main>
        </div>
    </div>
